...
const Candidate = sequelize.define('Candidate', {
  ...
  positionApplying: {
    type: DataTypes.ENUM('Sales and Distribution Head Jaipur','Sales and Distribution Head Raj','Sales and Distribution Head MPCG','Business Analyst','Raj Head- Radio','Jaipur Head- Radio','Delhi Head- Print','OOH Delhi','OOH Mumbai','Dy. Raj Head-Print','VP Finance','VP IT & Transformation','Chartered Accountant','B2B Marketing Research','Business Head-Jaipur','Business Head-MP'),
    allowNull: false
  },
